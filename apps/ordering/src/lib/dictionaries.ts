...
const rawDictionaries: Record<Locale, Dict> = {
  ar: {
    ...
    menu: {
      ...
      closedNow: "مغلق الآن",
      closedBrowseHint: "يمكنك تصفح المنيو، لكن الطلب معطّل حتى موعد الفتح القادم",
      prepTime: "{{minutes}} دقيقة تقريبًا",
      badge: {
        bestseller: "الأكثر مبيعًا",
        new: "جديد",
        spicy: "حار",
        vegetarian: "نباتي",
        containsNuts: "يحتوي مكسرات",
        containsDairy: "يحتوي ألبان",
  ...
  en: {
    ...
    menu: {
      ...
      closedBrowseHint: "You can still browse the menu, but ordering is disabled until it reopens",
